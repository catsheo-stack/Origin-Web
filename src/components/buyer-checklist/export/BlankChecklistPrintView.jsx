...
import { getPropertyTypeLabel } from "@/utils/printSummary";
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-white overflow-y-auto">
      <div className="no-print sticky top-0 bg-white border-b border-gray-200 px-4 py-2 flex items-center justify-between z-10">
        <h2 className="text-sm font-medium text-gray-700">空白清單預覽</h2>
      ...
      <div className="print-view p-8 max-w-[800px] mx-auto text-black">
        <div className="text-center mb-6">
          <h1 className="text-xl font-bold">置業旅程—空白清單</h1>
          <p className="text-xs text-gray-600 mt-1">物業類型： {getPropertyTypeLabel(propertyType)}</p>
        </div>
              ...
              <table className="w-full text-xs border-collapse">
                <thead>
                  <tr className="border-b border-gray-300">
                    ...
                    <th className="text-left py-0.5 pr-2">任務</th>
                    <th className="text-left py-0.5 px-2" style={{ width: "90px" }}>負責人</th>
                    <th className="text-left py-0.5 px-2" style={{ width: "75px" }}>到期日</th>
                    <th className="text-left py-0.5 pl-2" style={{ width: "120px" }}>備註</th>
                  </tr>
                </thead>
                <tbody>
