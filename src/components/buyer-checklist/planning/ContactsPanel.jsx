...
import ContactCard from "@/components/buyer-checklist/planning/ContactCard";
import ContactFormDialog from "@/components/buyer-checklist/planning/ContactFormDialog";

const FILTERS = [
  { id: "all", label: "全部" },
  { id: "legal", label: "法律" },
  { id: "finance", label: "財務" },
  { id: "property", label: "物業" },
  { id: "inspection", label: "看房" },
  { id: "other", label: "其他" }
];
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div>
          <h2 className="text-lg font-semibold text-gray-900">我的專業聯絡人</h2>
          <p className="text-sm text-gray-500">儲存協助您購屋人士的基本聯絡資料。</p>
          <p className="text-xs text-amber-600 mt-1">只應輸入基本商務聯絡資料。</p>
        </div>
