  ...
  return (
    <div className="relative w-32 h-32 flex items-center justify-center">
      ...
      <div className="text-center">
        ...
        <p className="text-[10px] text-midnight/40 mt-1">滿分 100</p>
      </div>
    </div>
  );
}
    ...
    <div className="py-3 border-b border-stone/50 last:border-0">
      <div className="flex items-center justify-between mb-1.5">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-midnight/40 bg-stone/50 rounded-full px-2 py-0.5">{component.weight}% 權重</span>
        </div>
...
/**
 * Budget Health Score — a weighted score 滿分 100 assessing the buyer's
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-stone/60 overflow-hidden">
      <div className="bg-parchment px-6 py-4 border-b border-stone/60">
        <p className="text-xs tracking-widest uppercase text-golden font-medium mb-0.5">財務舒適度評分</p>
        <p className="text-sm text-midnight/60">根據六項關鍵因素評估您的整體購屋準備程度。</p>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-6">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-midnight/50 mt-1 max-w-md leading-relaxed">
              此評分綜合首期資金、購屋成本、緊急備用金、還款能力、現有債務及貸款價值比。60 分以上代表財務狀況較穩健，80 分以上則顯示準備程度良好。
            </p>
          </div>
        </div>
        <div>
