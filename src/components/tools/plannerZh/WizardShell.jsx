    ...
    <div>
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          <p className="text-xs tracking-widest uppercase text-golden font-medium">第 {step} 步，共 {totalSteps} 步</p>
          <p className="text-xs text-midnight/40">{Math.round(pct)}% 完成</p>
        </div>
