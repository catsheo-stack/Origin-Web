...
const CHECKLIST = [
  { label: "已完成購屋預算規劃", desc: "Your purchase budget has been estimated based on income and deposit." },
  { label: "已估算購屋成本", desc: "Stamp duty, legal fees and upfront costs have been calculated." },
  { label: "已開始財務規劃", desc: "Your borrowing position and repayments have been assessed." },
  { label: "已準備尋找物業", desc: "You're ready to begin or refine your property search." },
];
