...
/**
 * Reality Check — an easy-to-read summary of the buyer's position, with
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-stone/60 overflow-hidden">
      <div className="bg-parchment px-6 py-4 border-b border-stone/60">
        <p className="text-xs tracking-widest uppercase text-golden font-medium mb-0.5">Reality Check</p>
        <p className="text-sm text-midnight/60">A clear summary of where you stand and what to consider.</p>
      </div>
      <div className="p-6">
        <div>
