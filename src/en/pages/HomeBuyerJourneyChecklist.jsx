...
import useBuyerChecklist from "@/en/hooks/useBuyerChecklist";
import {
  getOverallProgress,
  getCurrentStage,
  getNextAction,
  getDashboardCounts
} from "@/en/utils/checklistProgress";
import StageAccordion from "@/en/components/buyer-checklist/StageAccordion";
import PropertyTypeSelector from "@/en/components/buyer-checklist/PropertyTypeSelector";
import ProgressSummary from "@/en/components/buyer-checklist/ProgressSummary";
import JourneyProgress from "@/en/components/buyer-checklist/JourneyProgress";
import DashboardSummaryCards from "@/en/components/buyer-checklist/DashboardSummaryCards";
import PlanningNavigation from "@/en/components/buyer-checklist/planning/PlanningNavigation";
import BuyerPreferencesPanel from "@/en/components/buyer-checklist/planning/BuyerPreferencesPanel";
import PropertyShortlistPanel from "@/en/components/buyer-checklist/planning/PropertyShortlistPanel";
import PropertyComparison from "@/en/components/buyer-checklist/planning/PropertyComparison";
import PropertyComparisonPrintSummary from "@/en/components/buyer-checklist/planning/PropertyComparisonPrintSummary";
import ImportantDatesPanel from "@/en/components/buyer-checklist/planning/ImportantDatesPanel";
import RisksPanel from "@/en/components/buyer-checklist/planning/RisksPanel";
import ContactsPanel from "@/en/components/buyer-checklist/planning/ContactsPanel";
import DownloadMenu from "@/en/components/buyer-checklist/export/DownloadMenu";
import ProgressSummaryPrintView from "@/en/components/buyer-checklist/export/ProgressSummaryPrintView";
import BlankChecklistPrintView from "@/en/components/buyer-checklist/export/BlankChecklistPrintView";
import RestoreBackupDialog from "@/en/components/buyer-checklist/export/RestoreBackupDialog";
import { buildTaskExportRecords, checklistCsvHeaders, recordsToCsvRows } from "@/en/utils/checklistExport";
import { downloadCsv, dateStamp } from "@/en/utils/csvExport";
import { downloadBackup } from "@/en/utils/backupExport";
import { buildPrintSummary } from "@/en/utils/printSummary";
...
export default function HomeBuyerJourneyChecklist() {
  ...
  const handleToggleReject = useCallback((id) => {
    ...
    if (prop) {
      updateProperty(id, { status: prop.status === "Rejected" ? "Saved" : "Rejected" });
    }
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 sm:py-10">
        ...
        <div className="mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900">
            Plan and Track Your Home Buying Journey
          </h1>
          <p className="text-sm text-gray-600 mt-1.5">
            Use this checklist to manage each stage of buying a property yourself.
          </p>
          <p className="text-xs text-gray-500 mt-0.5">
            Track tasks, deadlines, risks and professional checks from property search to key handover.
          </p>
          <div className="flex flex-col sm:flex-row gap-1.5 mt-2.5 text-xs">
            ...
            <span className="inline-flex items-center gap-1 text-amber-600 sm:ml-2">
              ...
              Do not enter confidential financial, identity or legal information.
            </span>
          </div>
          <div className="mt-3">
            <DownloadMenu
          ...
          <div className="mb-8 space-y-4">
            {!Object.values(buyerPreferences).some(v =>
              ...
              <div className="bg-white rounded-lg border p-4 text-center">
                <p className="text-sm text-gray-400">Add your preferences to focus your property search.</p>
              </div>
            )}
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This resets checklist progress only. Your saved planning information will remain.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will permanently delete all checklist progress, property type, buyer preferences, saved properties, important dates, risks and contacts from this browser. This cannot be undone.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                <AlertDialogCancel>Cancel</AlertDialogCancel>
                <AlertDialogAction onClick={deleteLocalData} className="bg-red-600 hover:bg-red-700">Delete</AlertDialogAction>
                </AlertDialogFooter>
                </AlertDialogContent>
                </AlertDialog>
                </div>
