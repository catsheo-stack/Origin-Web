...
import { validateBackup, validateBackupFile } from "@/en/utils/backupValidation";
        ...
        {success ? (
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">Accepts .json files up to 2 MB</p>
            </div>
            ...
            {validatedData && (
              <div className="p-3 bg-amber-50 rounded-md">
                <p className="text-sm font-medium text-amber-800 mb-1">Restore this backup?</p>
