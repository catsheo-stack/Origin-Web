...
import { getStageProgress, getStageStatus } from "@/en/utils/checklistProgress";
import StageProgressCard from "@/en/components/buyer-checklist/StageProgressCard";
...
export default function JourneyProgress({ checklistData, taskStates, propertyType, today, currentStageId, openStages, onToggleStage }) {
  ...
  return (
    <div className="mb-6">
      <h2 className="text-xs font-semibold uppercase tracking-wider text-gray-500 mb-2.5">Your Journey</h2>
