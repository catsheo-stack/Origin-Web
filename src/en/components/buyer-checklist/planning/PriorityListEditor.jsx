...
import { PRIORITY_LIST_LABELS } from "@/en/utils/buyerJourneyValidation";
            ...
            {editingIndex === index ? (
              <>
                <Input
                  ...
                  autoFocus
                />
                <button onClick={saveEdit} className="p-0.5 hover:text-emerald-600" aria-label="Save edit">
                  <Check className="w-3 h-3" />
                </button>
                <button onClick={() => setEditingIndex(null)} className="p-0.5 hover:text-gray-500" aria-label="Cancel edit">
                  <X className="w-3 h-3" />
                </button>
              </>
            ) : (
