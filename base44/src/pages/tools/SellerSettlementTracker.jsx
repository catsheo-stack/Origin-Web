...
import { SELLER_SETTLEMENT_MILESTONES } from "@/data/tools/sellerSettlementTracker";
...
export default function SellerSettlementTracker() {
  ...
  useEffect(() => {
    document.title = "Seller Settlement Tracker | Origin Concierge";
    ...
    setMeta('meta[property="og:title"]', "content", "Seller Settlement Tracker | Origin Concierge");
    ...
    const schema = [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Seller Settlement Tracker", item: "https://originpropertyconcierge.com.au/tools/seller-settlement-tracker" },
        ],
      },
      {
        "@context": "https://schema.org",
  ...
  const handleDownload = () => {
    ...
    toast({ title: "Report downloaded", description: "Your Seller Settlement Tracker PDF has been saved." });
  };
  ...
  return (
    <>
      <ToolHero
        ...
        title="Seller Settlement Tracker"
        subtitle="Track every important milestone from accepting an offer through to settlement and receiving your sale proceeds."
        primaryCta={{ label: "Start Tracking", href: "#details", analyticsKey: "seller_settlement_start" }}
      />

      <SectionWrapper id="details" className="!pt-12 !pb-8 scroll-mt-24">
        <SellerPropertyDetailsForm values={property} onChange={setProperty} onSubmit={handleStart} started={started} onRestart={() => setResetDialog({ open: true, mode: "restart" })} />
      </SectionWrapper>
      ...
      {started && (
        <>
          ...
          <CTABanner
            ...
            subtitle="Whether you're selling your home or investment property, we're here to guide you through every stage of settlement."
